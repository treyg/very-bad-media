    ...
    <Container maxW={"3xl"}>
      ...
      >
          ...
          <Box display="flex" alignItems="center" justifyContent="center">
            <Box position="relative">
              ...
              <Box mt="20px" display="flex" mx="auto" justifyContent="center">
                <Icon color={headingColor} w={71} transform="rotate(51.2deg)">
                  <Arrow />
                </Icon>
                <Text
                  fontSize="5xl"
        ...
        <Container marginInline="auto !important" mt="28px !important">
          <Text as={"h2"} color={textColor}>
            Media lists for books, movies, and short stories discussed and
            recommended on the Very Bad Wizards podcast.
          </Text>
        </Container>
        <Stack
          direction={"row"}
        ...
        <Button asChild variant="plain" color={accentColor}>
...
const Arrow = (props) => (
  <svg viewBox="0 0 72 24" fill="none" {...props}>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
