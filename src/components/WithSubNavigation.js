      ...
      >
        ...
        >
          <IconButton
            ...
            onClick={toggleColorMode} // Add the toggleColorMode function to the IconButton
            variant="ghost"
          />
      ...
      <Stack direction={'row'} align={'center'}>
        <Box>
          <Text
            ...
            _groupHover={{ color: 'light.primary' }}
            fontWeight={500}
          >
            {label}
          </Text>
        ...
        <Flex
          ...
          flex={1}
        >
          <Icon color={'light.primary'} w={5} h={5} as={ChevronRightIcon} />
        </Flex>
      </Stack>
    </Link>
  )
